...
function renderTasks(tasks) {
  ...
  // This method takes the array of HTML strings(created by the map() operation) and
  // concatenates them into a single string, with an empty string("") as the separator.
  // This effectively joins all the individual list item HTML strings together to form a
  // single continuous string.
  // Since the map() operations calls a function an function needs to be created to return
  // the HTML for each individual list item.
