 ...
 *
 * @param {Array} list - The list of items to search through
 *                Each item should be an object with `name`, `description`, and `tags`
 *              properties.
 * @param {string} query - The search query to filter the list by.
 * @returns {Array} - A new list containing items that match the search query.
 */
